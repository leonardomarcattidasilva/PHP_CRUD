...
<html lang="pt_BR">
    ...
    <body>
        ...
        <div class="col-4 offset-4" id="form-container">
            <form action="add_functions.php" method="post">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <button type="submit" class="btn btn-success">Adicionar <i class="fas fa-plus"></i></button>
                    <button type="reset" class="btn btn-warning">Limpar <i class="fas fa-brush"></i></button>
                </div>
            </form>
        </div>
    </body>
